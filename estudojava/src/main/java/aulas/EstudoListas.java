...
public class EstudoListas {
    public static void main(String[] args) {
        // Não aceita os tipos primitivos, então preciso usar as wrapper classes
        ...
        System.out.println(numeros);
        System.out.println(numeros.get(2)); // Pega o valor da posição 2 → 1000

        numeros.set(0,500); // Equivalente a numeros[0] = 500
        System.out.println(numeros);
        ...
        System.out.println(numeros.size()); // equivalente ao array.length
